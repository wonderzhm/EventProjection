...
## 17. Additional simulation utilities

The package also includes utilities inherited from the cure-oriented workflow:
...
- cure-model survival-probability and log-likelihood helpers such as `SP_Chen_weibull()` and `loglik_Chen_weibull()`

These are most useful for simulation studies and operating-characteristic evaluation rather than routine projection alone.
